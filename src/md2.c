	...
	while ((ch = getopt_long(argc, argv, "hV", long_options, NULL)) != -1) {
		switch (ch) {
			case 'h':
				...
				fprintf(stdout, "\n");
				fprintf(stdout, "usage: md2 [OPTIONS] [FILEn");
				fprintf(stdout, "\n");
				...
				fprintf(stdout, "\n");
				fprintf(stdout, "  # print the MD2 message digest of a file\n");
				fprintf(stdout, "  md2 foo.txt\n");
				fprintf(stdout, "\n");
				...
				break;
			case 'V':
				fprintf(stdout, "md2 (tcutils) v1.0.0\n");
